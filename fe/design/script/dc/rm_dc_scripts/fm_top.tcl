...
puts "RM-Info: Sourcing script file [which ${DCRM_AUTOREAD_RTL_SCRIPT}]\n"
source ${DCRM_AUTOREAD_RTL_SCRIPT}
...
# }
#read_verilog -i ${DCRM_FINAL_VERILOG_OUTPUT_FILE}
...
read_ddc -i ${DCRM_FINAL_DDC_OUTPUT_FILE}
...
if { ![verify] }  {  
  ...
  report_aborted > ${FMRM_ABORTED_POINTS_REPORT}
